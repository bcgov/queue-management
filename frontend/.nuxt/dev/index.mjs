...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery as getQuery$1, getCookie, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///root/repos/queue-management/frontend/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///root/repos/queue-management/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///root/repos/queue-management/frontend/node_modules/devalue/index.js';
import destr, { destr as destr$1 } from 'file:///root/repos/queue-management/frontend/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, withLeadingSlash, withoutTrailingSlash, isRelative, joinRelativeURL } from 'file:///root/repos/queue-management/frontend/node_modules/ufo/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///root/repos/queue-management/frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///root/repos/queue-management/frontend/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///root/repos/queue-management/frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///root/repos/queue-management/frontend/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///root/repos/queue-management/frontend/node_modules/klona/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///root/repos/queue-management/frontend/node_modules/scule/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///root/repos/queue-management/frontend/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///root/repos/queue-management/frontend/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///root/repos/queue-management/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///root/repos/queue-management/frontend/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///root/repos/queue-management/frontend/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///root/repos/queue-management/frontend/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///root/repos/queue-management/frontend/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///root/repos/queue-management/frontend/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///root/repos/queue-management/frontend/node_modules/vue/index.mjs';
import { extname, basename } from 'file:///root/repos/queue-management/frontend/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///root/repos/queue-management/frontend/node_modules/unified/index.js';
import { toString } from 'file:///root/repos/queue-management/frontend/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///root/repos/queue-management/frontend/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///root/repos/queue-management/frontend/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///root/repos/queue-management/frontend/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///root/repos/queue-management/frontend/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///root/repos/queue-management/frontend/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///root/repos/queue-management/frontend/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file:///root/repos/queue-management/frontend/node_modules/slugify/slugify.js';
import remarkParse from 'file:///root/repos/queue-management/frontend/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///root/repos/queue-management/frontend/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///root/repos/queue-management/frontend/node_modules/remark-mdc/dist/index.mjs';
import remarkEmoji from 'file:///root/repos/queue-management/frontend/node_modules/remark-emoji/index.js';
import remarkGFM from 'file:///root/repos/queue-management/frontend/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///root/repos/queue-management/frontend/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///root/repos/queue-management/frontend/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///root/repos/queue-management/frontend/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///root/repos/queue-management/frontend/node_modules/rehype-raw/index.js';
import { detab } from 'file:///root/repos/queue-management/frontend/node_modules/detab/index.js';
import { toString as toString$1 } from 'file:///root/repos/queue-management/frontend/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///root/repos/queue-management/frontend/node_modules/github-slugger/index.js';
import { getIcons } from 'file:///root/repos/queue-management/frontend/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///root/repos/queue-management/frontend/.nuxt/nuxt-icon-server-bundle.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/root/repos/queue-management/frontend/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/root/repos/queue-management/frontend/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/root/repos/queue-management/frontend/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/root/repos/queue-management/frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/root/repos/queue-management/frontend/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/root/repos/queue-management/frontend/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/root/repos/queue-management/frontend/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/root/repos/queue-management/frontend/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _IgOoqVPesX = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/root/repos/queue-management/frontend";
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///root/repos/queue-management/frontend/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _846QPAMEJE = defineNitroPlugin(async (nitro) => {
...
const _lazy_R8NvUD = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.json', handler: _cledFL, lazy: false, middleware: false, method: "get" },
...
const getClientManifest = () => import('file:///root/repos/queue-management/frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);

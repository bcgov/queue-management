...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///workspace/frontend/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///workspace/frontend/node_modules/ohash/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///workspace/frontend/node_modules/defu/dist/defu.mjs';
import { basename, extname } from 'file:///workspace/frontend/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///workspace/frontend/node_modules/scule/dist/index.mjs';
import { unified } from 'file:///workspace/frontend/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///workspace/frontend/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///workspace/frontend/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///workspace/frontend/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///workspace/frontend/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///workspace/frontend/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///workspace/frontend/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///workspace/frontend/node_modules/micromark-util-sanitize-uri/dev/index.js';
import remarkParse from 'file:///workspace/frontend/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///workspace/frontend/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///workspace/frontend/node_modules/remark-mdc/dist/index.mjs';
import remarkEmoji from 'file:///workspace/frontend/node_modules/remark-emoji/index.js';
import remarkGFM from 'file:///workspace/frontend/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///workspace/frontend/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///workspace/frontend/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///workspace/frontend/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///workspace/frontend/node_modules/rehype-raw/index.js';
import { detab } from 'file:///workspace/frontend/node_modules/detab/index.js';
import { toString } from 'file:///workspace/frontend/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///workspace/frontend/node_modules/github-slugger/index.js';
import destr, { destr as destr$1 } from 'file:///workspace/frontend/node_modules/destr/dist/index.mjs';
import slugify from 'file:///workspace/frontend/node_modules/slugify/slugify.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///workspace/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///workspace/frontend/node_modules/devalue/index.js';
import { propsToString, renderSSRHead } from 'file:///workspace/frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///workspace/frontend/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///workspace/frontend/node_modules/unenv/runtime/fetch/index.mjs';
...
import { consola } from 'file:///workspace/frontend/node_modules/consola/dist/index.mjs';
...
import { isVNode, version, unref } from 'file:///workspace/frontend/node_modules/vue/index.mjs';
import { getIcons } from 'file:///workspace/frontend/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///workspace/frontend/.nuxt/nuxt-icon-server-bundle.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///workspace/frontend/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///workspace/frontend/node_modules/@unhead/shared/dist/index.mjs';
...
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/workspace/frontend/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/workspace/frontend/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspace/frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspace/frontend/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspace/frontend/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspace/frontend/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/workspace/frontend/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _htElyeltb1 = (function(nitro) {
...
const _URW1glZMAq = defineNitroPlugin(async (nitro) => {
...
const _Ug82KUOiD3 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _VqYSQk = defineCachedEventHandler(async (event) => {
...
const _N3uDF6 = defineEventHandler(async (event) => {
...
const _0sbPEw = defineEventHandler(async (event) => {
...
const _M1e5rF = defineEventHandler(async (event) => {
  const { getContentQuery } = await Promise.resolve().then(function () { return query; });
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _lazy_9suXxZ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_9suXxZ, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _VqYSQk, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _N3uDF6, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _N3uDF6, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _N3uDF6, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _0sbPEw, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _M1e5rF, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _M1e5rF, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _M1e5rF, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_9suXxZ, lazy: true, middleware: false, method: undefined }
];
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///workspace/frontend/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);

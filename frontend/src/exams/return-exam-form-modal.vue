      ...
      <div v-bind:class="{ 'edit-exam-modal-content': !editExamSuccess, 'exam-modal-content-message': editExamSuccess }">
        ...
        <div>
          <div v-if="editExamFailure">
            <b-row>
              <b-col>
                <h1 style="color:red">Error During Submission</h1>
                <p style="color:red"><b>Your changes were not submitted. Please contact and Administrator.</b></p>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions([ 'getExams',
                            'putExamInfo' ]),
            ...mapMutations([ 'toggleReturnExamModalVisible',
                              'setEditExamSuccess',
                              'setEditExamFailure' ]),
            cancel() {

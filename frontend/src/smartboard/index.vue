...
<template>
  <div class="main-container">
    <CallByNumber v-if="officetype==='callbyticket'"></CallByNumber>
...
<style>
  .board-footer-div { display: flex; position: fixed; bottom: 0; left: 0; margins: 0px; height:13%; width: 100%;
    justify-content: flex-start; align-items: center; font-size:2.2rem; }
  ...
  .flex-title { font-size: 3.6rem; color: darkblue;
  ...
  .flex-title-2 { font-size: 2.0rem; color: midnightblue}
</style>

...
class Period(Base):
    ...
    sr_id           = db.Column(db.BigInteger, ForeignKey('service_req.sr_id'))
    csr_id          = db.Column(db.BigInteger, ForeignKey('csr.csr_id'))
    reception_csr   = db.Column(Integer)
    channel_id      = db.Column(db.BigInteger, ForeignKey('channel.channel_id'))
    ps_id           = db.Column(db.BigInteger, ForeignKey('period_state.ps_id'))

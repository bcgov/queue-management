...
class CSRTable(MyBase, Base, db.model):

	model = api.model ('CSRTable' {
	...
	def __init__ (self, csr_id, username, password, office_id_in_now, role_id, qt_xn_csr_now, receptionist_now, deleted, csr_state_id_now):
		self.csr_id = csr_id
	...
	def json(self, csr_id, username, password, office_id_in_now, role_id, qt_xn_csr_now, receptionist_now, deleted, csr_state_id_now):
		return {"csr_id" : self.csr_id, "username" : self.username, "password" : self.password, "office_id_in_now" : office_id_in_now, "role_id" : self.role_id, "qt_xn_csr_now" : self.qt_xn_csr_now, "receptionist_now" : self.receptionist_now, "deleted" : self.deleted, "csr_state_id_now" : self.csr_state_id_now}
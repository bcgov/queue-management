...
class ServiceTable(MyBase, Base, db.model):

    model = api.model('ServiceTable' {
    ...
    def __init__(self, service_id, service_code, service_name, service_desc, parent_id, deleted, prefix, 
                display_dashboard, actual_service)
    ...
    def json(json, service_id, service_code, service_name, service_desc, parent_id, deleted, prefix, display_dashboard, 
            actual_service)
        return {"service_id" : self.service_id, "service_code" : self.service_code, "service_name" : self.service_name,
                "service_desc" : self.service_desc, "parent_id" : self.parent_id, "deleted" : self.deleted, 
                "prefix" : self.prefix, "display_dashboard" : self.display_dashboard, 

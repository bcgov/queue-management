...
class CitizenFinishService(Resource):
    ...
    def post(self, id):
        ...
        active_quantity = active_service_request.quantity
        ...
        SnowPlow.snowplow_event(citizen.citizen_id, csr, "finish", quantity = active_quantity)
        ...
        if len(citizen.service_reqs) != 1:
            for sr in citizen.service_reqs:
                if sr.sr_id != active_sr_id:
                    SnowPlow.snowplow_event(citizen.citizen_id, csr, "finishstopped", sr.quantity)

...
class CSRConfig(Base):
    ...
    column_list = ['username', 'office.office_name', 'ita_designate', 'pesticide_designate', 'role.role_desc', 'deleted']
    column_labels = {
        'username': 'Username',
    ...
    column_sortable_list = ('username', 'office.office_name', 'ita_designate', 'pesticide_designate', 'role.role_desc', 'deleted')

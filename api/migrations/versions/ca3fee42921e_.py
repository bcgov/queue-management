...
Revision ID: ca3fee42921e
Revises: 
Create Date: 2018-06-19 19:22:24.696360
...
def upgrade():
    ...
    sa.Column('deleted', sa.DateTime(), nullable=True),
    sa.Column('csr_state_id', sa.Integer(), nullable=True),
    ...
    sa.Column('sr_state_id', sa.Integer(), nullable=True),
    ...
    sa.Column('sr_id', sa.Integer(), nullable=True),
